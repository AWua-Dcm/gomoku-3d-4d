...
[![断言](https://img.shields.io/badge/%E6%96%AD%E8%A8%80-40466_%E9%A1%B9%E5%85%A8%E7%BB%BF-2f6f4e?style=flat-square)](_verify/run-all.sh)
...
```
11733 + 19408 + 98 + 89 + 8845 + 115 + 178 = 40466 项断言全绿
```
...
| `node Web_Gomoku3D/tests/dom-smoke.test.mjs` | 89 | 界面桩环境（含中英双语切换、手势与复位的边界值） |
...
| `node _verify/browser-check.mjs` | 178 | 真实浏览器（GLSL 编译、布局几何、控制台报错、英文排版、合成多点触摸） |
...
> 最新的在最上面。标着「开发中」的那条还没发布。

### 2026.09.26

- 🌐 **v2.8.0** 新增日韩俄法语言 —— **开发中，尚未发布**
