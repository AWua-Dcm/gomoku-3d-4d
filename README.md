...
- 🐛 **v2.7.2** 修改竖屏英文版按键位置出错的问题

### 2026.09.25

- 🐛 **v2.7.1** 修改一些 bug
- 📱 **v2.7.0** 支持竖屏游玩，手机平板浏览器也可游玩
- ✨ **v2.6.0** 新增仅查看黑 / 白棋键，便于观察棋局

### 2026.09.24

- ✨ **v2.5.0** 新增取消立体棋盘格线键，便于观察棋局
- 🌐 **v2.4.0** 新增中英文切换键
- 🐛 **v2.3.3** 修改一些 bug，此项目上传至 GitHub
- 📝 **v2.3.2** 计划实现联机功能，暂未完全实现
- 🎨 **v2.3.1** 修改初始界面按钮的位置
- 🎨 **v2.3.0** 修改初始界面的「割裂感」，更加统一
- 📝 **v2.2.1** 修改规则说明
- ✨ **v2.2.0** 新增右上角规则说明
- 🎨 **v2.1.0** 更改了游戏界面，修改一些细节问题
- ✨ **v2.0.0** 新增四维五子棋（「四维」指可以像魔方一样转动立体棋盘，后续更新玩法）
